...
"\
\\001\000\001\000\011\000\003\000\010\000\009\000\009\000\011\000\008\000\
\\014\000\007\000\015\000\006\000\000\000\
\\001\000\002\000\019\000\003\000\018\000\004\000\017\000\005\000\016\000\
\\006\000\015\000\007\000\014\000\008\000\013\000\010\000\012\000\
\\012\000\032\000\000\000\
\\001\000\002\000\019\000\003\000\018\000\004\000\017\000\005\000\016\000\
\\006\000\015\000\007\000\014\000\008\000\013\000\010\000\012\000\
\\013\000\035\000\000\000\
\\001\000\003\000\010\000\009\000\009\000\011\000\008\000\014\000\007\000\
\\015\000\006\000\000\000\
\\001\000\006\000\033\000\000\000\
\\001\000\014\000\023\000\000\000\
\\001\000\016\000\000\000\000\000\
\\038\000\002\000\019\000\003\000\018\000\004\000\017\000\005\000\016\000\
\\006\000\015\000\007\000\014\000\008\000\013\000\010\000\012\000\000\000\
\\039\000\000\000\
\\040\000\000\000\
\\041\000\000\000\
\\042\000\000\000\
...
"\000\000\020\000\009\000\007\000\
\\023\000\021\000\003\000\003\000\
\\003\000\005\000\003\000\003\000\
\\003\000\003\000\003\000\003\000\
\\003\000\003\000\001\000\019\000\
\\018\000\004\000\016\000\017\000\
\\015\000\014\000\013\000\012\000\
\\011\000\010\000\022\000\003\000\
...
val terms : term list = nil
 $$ (T 15) $$ (T 12) $$ (T 11) $$ (T 10) $$ (T 9) $$ (T 8) $$ (T 7)
...
|  ( 14, ( ( _, ( MlyValue.NAME NAME1, NAME1left, NAME1right)) :: 
rest671)) => let val  result = MlyValue.AtomExpr (fn _ => let val  (
NAME as NAME1) = NAME1 ()
 in (Var(NAME))
end)
...
|  ( 15, ( ( _, ( _, _, RPAR1right)) :: ( _, ( MlyValue.Expr Expr1, _,
...
|  ( 16, ( ( _, ( MlyValue.CINT CINT1, CINT1left, CINT1right)) :: 
...
ParserData.MlyValue.VOID,p1,p2))
fun LOGICAND (p1,p2) = Token.TOKEN (ParserData.LrTable.T 9,(
ParserData.MlyValue.VOID,p1,p2))
fun LPAR (p1,p2) = Token.TOKEN (ParserData.LrTable.T 10,(
ParserData.MlyValue.VOID,p1,p2))
fun RPAR (p1,p2) = Token.TOKEN (ParserData.LrTable.T 11,(
ParserData.MlyValue.VOID,p1,p2))
fun SEMIC (p1,p2) = Token.TOKEN (ParserData.LrTable.T 12,(
ParserData.MlyValue.VOID,p1,p2))
