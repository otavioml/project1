...
\\000"
 ...
 (1, 
"\003\003\003\003\003\003\003\003\003\021\023\003\003\003\003\003\
\\003\003\003\003\003\003\003\003\003\003\003\003\003\003\003\003\
\\021\020\003\003\003\003\018\003\017\016\015\014\003\013\003\012\
...
{fin = [], trans = 1},
{fin = [(N 38)], trans = 0},
{fin = [(N 10),(N 38)], trans = 4},
{fin = [(N 10)], trans = 4},
{fin = [(N 20),(N 38)], trans = 0},
{fin = [(N 28),(N 38)], trans = 7},
{fin = [(N 31)], trans = 0},
{fin = [(N 22),(N 38)], trans = 0},
{fin = [(N 7),(N 38)], trans = 10},
{fin = [(N 7)], trans = 10},
{fin = [(N 18),(N 38)], trans = 0},
{fin = [(N 14),(N 38)], trans = 0},
{fin = [(N 12),(N 38)], trans = 0},
{fin = [(N 16),(N 38)], trans = 0},
{fin = [(N 26),(N 38)], trans = 0},
{fin = [(N 24),(N 38)], trans = 0},
{fin = [(N 38)], trans = 18},
{fin = [(N 36)], trans = 0},
{fin = [(N 33),(N 38)], trans = 0},
{fin = [(N 4),(N 38)], trans = 21},
{fin = [(N 4)], trans = 21},
{fin = [(N 1)], trans = 0}])
end
...
| 26 => (RPAR(yypos, yypos))
| 28 => (LESS(yypos, yypos))
| 31 => (LESSEQUAL(yypos, yypos))
| 33 => (NEGATION(yypos, yypos))
| 36 => (LOGICAND(yypos, yypos))
| 38 => let val yytext=yymktext() in error("\n *** Lexer error: character invalid ***\n "); raise
