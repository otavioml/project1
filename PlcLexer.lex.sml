...
\\017\003\003\003\003\003\003\003\016\015\014\013\003\012\003\011\
\\009\009\009\009\009\009\009\009\009\009\003\008\007\006\003\003\
...
{fin = [], trans = 1},
{fin = [(N 30)], trans = 0},
{fin = [(N 10),(N 30)], trans = 4},
{fin = [(N 10)], trans = 4},
{fin = [(N 20),(N 30)], trans = 0},
{fin = [(N 28),(N 30)], trans = 0},
{fin = [(N 22),(N 30)], trans = 0},
{fin = [(N 7),(N 30)], trans = 9},
{fin = [(N 7)], trans = 9},
{fin = [(N 18),(N 30)], trans = 0},
{fin = [(N 14),(N 30)], trans = 0},
{fin = [(N 12),(N 30)], trans = 0},
{fin = [(N 16),(N 30)], trans = 0},
...
| 26 => (RPAR(yypos, yypos))
| 28 => (LESS(yypos, yypos))
| 30 => let val yytext=yymktext() in error("\n *** Lexer error: character invalid ***\n "); raise
