...
\\018\017\003\003\003\003\003\003\016\015\014\013\003\012\003\011\
...
{fin = [], trans = 1},
{fin = [(N 32)], trans = 0},
{fin = [(N 10),(N 32)], trans = 4},
{fin = [(N 10)], trans = 4},
{fin = [(N 20),(N 32)], trans = 0},
{fin = [(N 28),(N 32)], trans = 0},
{fin = [(N 22),(N 32)], trans = 0},
{fin = [(N 7),(N 32)], trans = 9},
{fin = [(N 7)], trans = 9},
{fin = [(N 18),(N 32)], trans = 0},
...
| 26 => (RPAR(yypos, yypos))
| 28 => (LESS(yypos, yypos))
| 30 => (NEGATION(yypos, yypos))
| 32 => let val yytext=yymktext() in error("\n *** Lexer error: character invalid ***\n "); raise
